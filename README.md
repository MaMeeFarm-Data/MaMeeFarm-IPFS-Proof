# MaMeeFarm™ IPFS Proof Repository  
**DGCP™ — Duck Governance & Continuous Proof**  
**MMFARM-POL-2025 — Proof-of-Work License**

This repository stores the official, tamper-proof **IPFS Evidence Units**  
generated daily from MaMeeFarm™, Lampang, Thailand.

All data here represents **Real-Work Data™** from everyday farm operations:
feeding ducks, collecting eggs, caring for dogs, tending crops,  
and maintaining the environment — captured as verifiable digital proof.

---

## 🔍 Purpose of This Repository
This repo serves as a **verifiable Data Layer**, separate from OpenSea or NFTs.
...
- 🌳 **File-tree manifests**  
- 📜 **Proof-of-Life / Proof-of-Work logs**  
- ⛓ **Immutable Git history**  
- 🧩 **Append-only evidence timeline**

This forms the foundation for DGCP™ and the MMFARM-POL-2025 protocol.

---

## 📂 Folder Structure
/proof/ → Human-readable proof files (Markdown)
/cid/ → CID mapping JSON files
/sha256/ → SHA-256 manifests for integrity verification
/manifests/ → File-tree structures per proof unit

Each Proof Unit is self-contained and fully auditable.

---

## 🔗 How This Repo Fits in the MaMeeFarm Data Stack

Camera → IPFS (Pinata) → GitHub Proof Repo → SHA-256 → (Optional) NFT
